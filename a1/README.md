...
Logging is done with Bash scripts that can be run by calling the script file, e.g. `bash Q2/logging.sh`.
This will create a set of logging files and a CSV, which can then be used by `Q2/plotbars.py` to make the plots in the report.
